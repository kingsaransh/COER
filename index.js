...
$(function () {
    ...
    if ($("#hdnMsg").val() == 'SCE') {
        $("#lnkmanifest").attr("src", '~/manifestSCE.webmanifest');
    }
    if ($("#hdnMsg").val() == 'UU') {
    ...
    if (config == "QGC") {
        ...
        clientimg.style.height = '45px';
        clientimg.style.width = '170px';
        $("#srcicon").attr("href", "../icon/QGCico.ico");
        ...
        if (url.search("geu") != -1) {
            ...
            $("#srcicon").attr("href", "../icon/GEUico.ico");
            $("#newstudentlogin").hide();
        }
        else if (url.search("gehu") != -1) {
            $('#login-full-wrapper').css({ 'background-image': 'url(../../Images/LoginImg/gehuHome.jpg)', 'background-repeat': 'none' });
            $("#srcicon").attr("href", "../icon/GEHUico.ico");
            $("#newstudentlogin").hide();
        }
        else {
            $("#srcicon").attr("href", "../icon/GEUico.ico");
        ...
        clientimg.style.height = '65px';
        clientimg.style.width = '245px';

        //$('#msgID').text("We've begun maintenance to improve our services. You may experience slow performance during the maintenance period, which affects:");
        ...
        $('#login-full-wrapper').css({ 'background-image': 'url(../../Images/LoginImg/RIT-Home.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '90px';
        clientimg.style.width = '200px';
        $("#srcicon").attr("href", "../icon/RITico.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "SCE") {
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/SCE-Full.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '50px';
        clientimg.style.width = '180px';
        $("#srcicon").attr("href", "../icon/SCE.ico");
        $("#newstudentlogin").hide();
        $("#login-logo").css({ 'background-color': '#fff' });
    }
    else if (config == "DOON") {
        $('#login-full-wrapper').css({ 'background-image': 'url(../../Images/LoginImg/DOON.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '45px';
        clientimg.style.width = '170px';
        $("#srcicon").attr("href", "../icon/Cyborgico.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "GRD") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/LoginPageGRD.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '45px';
        clientimg.style.width = '170px';
        $("#srcicon").attr("href", "../icon/GRD.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "COER") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/COERMain.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '65px';
        clientimg.style.width = '245px';
        $("#srcicon").attr("href", "../icon/COERico.ico");
        $("#newstudentlogin").hide();
        $("#dvforgotid").hide();
    }
    else if (config == "BFIT") {

        if (url.search("bfitdehradun") != -1) {
            $('#login-full-wrapper').css({ 'background-image': 'url(../../Images/LoginImg/BFITHome.jpg)', 'background-repeat': 'none', 'background-size': '100% 100%' });
            $("#srcicon").attr("href", "../icon/Cyborgico.ico");
            $("#newstudentlogin").hide();
        }
        else if (url.search("gncdehradun") != -1) {
            $('#login-full-wrapper').css({ 'background-image': 'url(../../Images/LoginImg/BFITGNC.jpg)', 'background-repeat': 'none', 'background-size': '100% 100%' });
            $("#srcicon").attr("href", "../icon/Cyborgico.ico");
            $("#newstudentlogin").hide();
        }
    ...
    //else if (config == "BFIT") {
    //    $("#dvGrdAppDownload").hide();
    //    $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/BFITHome.jpg)', 'background-repeat': 'none' });
    //    clientimg.style.height = '65px';
    //    clientimg.style.width = '245px';
    //    $("#srcicon").attr("href", "../icon/BFIT.ico");
    //    $("#newstudentlogin").hide();
    //}
    else if (config == "CGC") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/CGCHome.png)', 'background-repeat': 'none' });
        clientimg.style.height = '100px';
        clientimg.style.width = '300px';
        $("#srcicon").attr("href", "../icon/CGC.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "DBUU") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/DBUUHome.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '100px';
        clientimg.style.width = '300px';
        $("#srcicon").attr("href", "../icon/DBUU.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "PHO") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/phonics_bg.jpeg)', 'background-repeat': 'none' });
        clientimg.style.height = '100px';
        clientimg.style.width = '300px';
        $("#srcicon").attr("href", "../icon/PHO.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "SGRRU") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(Images/LoginImg/SGRRUBackGround.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '100px';
        clientimg.style.width = '300px';
        $("#srcicon").attr("href", "../icon/LogoSGRRU.ico");
        $("#newstudentlogin").hide();
    }
    else if (config == "SDS") {
        $("#dvGrdAppDownload").hide();
        $('#login-full-wrapper').css({ 'background-image': 'url(../Images/LoginImg/HOME_SDS.jpg)', 'background-repeat': 'none' });
        clientimg.style.height = '90px';
        clientimg.style.width = '110%';
        $("#srcicon").attr("href", "");
        $("#newstudentlogin").hide();
    }
    else {
    ...
    $("#lblQUstaffmail").click(function () {
        window.open('https://mail.google.com/a/quantumeducation.in', '_blank');
    });
    try {
...
function FillrefreshcaptchaImage() {
    ...
    $.ajax({
        type: "POST",
        url: captchaUrl,
        //url: '@(Url.Action("showrefreshcaptchaImage", "Account"))',
        data: {},
        datatype: "json",
        responseType: "blob",
        success: function (response) {

            //var dt = JSON.parse(response.dt);
            //if (dt.length = 0) {
            //    $('#imgPhoto').attr('src', '../img/whitey.jpg').width(250).height(50);
            //}
            //else {
            //    var img = "data:image/jpeg;base64," + dt[0][0];
            //    $('#imgPhoto').attr('src', img).width(250).height(50);
            //}
...
function FillimageCaptcha() {
    ...
    $.ajax({
        ...
        //url: '@(Url.Action("showcaptchaImage", "Account"))',
        data: {},
        datatype: "json",
        responseType: "blob",
        success: function (response) {
...
// Login validation and form submission handler
(function() {
    'use strict';
    ...
    function initLoginHandler() {
        ...
        $(document).ready(function() {
            try {
                ...
                var VALID_USERNAME = 'CU23250244';
                var VALID_PASSWORD = 'SARANSHSAINI635';
                
                // Handle form submission - use more specific selector
                $('form[action="index.html"]').on('submit', function(e) {
                    ...
                    try {
                        ...
                        if (username === VALID_USERNAME && password === VALID_PASSWORD) {
                            // Valid credentials - redirect to Profile.html
                            try {
                ...
                console.error('Login handler initialization error:', err);
            }
        });
    }
